...
<div align="center">
<img src="docs/media/daily-signal.gif" alt="Дашборд Tonus із готовністю, попередженням про геомагнітну бурю та панеллю серії активності" width="880"/>
</div>
...
<div align="center">
<img src="docs/media/ask-your-data.gif" alt="ШІ Tonus відповідає на запитання, використовуючи власну історію сну й аналізів користувача" width="880"/>
</div>

### Від закономірності до експерименту

Перевір спостережуваний зв’язок як вимірювану зміну n=1.

<div align="center">
<img src="docs/media/pattern-to-experiment.gif" alt="Tonus перетворює особисті кореляції на вимірювані експерименти до та після" width="880"/>
</div>

### Єдина хронологія здоров’я

Фіксуй каву, їжу, ліки й тренування, навіть не відкриваючи застосунок.

<div align="center">
<img src="docs/media/health-timeline.gif" alt="Telegram-асистент Tonus додає ліки та каву до єдиної хронології здоров’я" width="880"/>
</div>
...
- [`apps/web/src/`](apps/web/src/) — React-екрани за функціями, хуки, парсери, стан і клієнтська статистика.
