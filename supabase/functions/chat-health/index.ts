...
- Раздел «Наблюдения пациента» — это его собственные свободные записи, а не
  измерения: ссылайся на них как на слова пользователя («ты записал, что…»),
  не превращай их в цифры и не выводи из них шкалу.
